            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                   <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="ViewBill.jsp">View Bill</a></li>
			...
			<div class="row">
				<div class="text-center">
                   ...
                   Connection con=Dbconnection.getConnection();
                    ...
                    ResultSet r=st.executeQuery("select * from flatdetails where email='"+email+"'");
                    while(r.next()){
...
int total=Integer.parseInt(flatmaintenance)+Integer.parseInt(vehiclemaintenance)+Integer.parseInt(water)+Integer.parseInt(parking)+Integer.parseInt(eventfund);
                        ...
                        <tR>
                         <td><%=fno%></td>
                            ...
                            <td><%=eventfund%></td><td><%=month%></tD><td><%=total%>RS/-</tD>
                            <td><%=r.getString("status")%></td>
                            <td><a href="Pay.jsp?email=<%=email%>&fno=<%=fno%>&month=<%=month%>">Pay Bill</a></tD>
                        </tr>   
                   <% }
