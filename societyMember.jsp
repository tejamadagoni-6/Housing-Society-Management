		...
		<div class="container">
			<div class="row">
				<div class="text-center">
                                    ...
                                    if(value==null){%>
					<h3>Society  Member Login</h3>
                                        <form name="login" action="SocietyMemberLogin.jsp" method="post">
                                        <table>
                                            <tr>
                                            ...
                                            <tr><td>Don't Have Password ? <a href="societyMember.jsp?value='create'">Create Password</a></td></tr>
                                            </tr>
                                        </table>
                                        </form>
                                        <%}else{
...
<form action="societyMember.jsp" method="post">
<table>
...
if(email!=null){
   ...
   if(r.next()){
       ...
       response.sendRedirect("societyMember1.jsp?msg=success");  
   }else{
       %>
