            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="Create_Event.jsp">Create Event</a></li>
			...
			<div class="row">
				<div class="text-center">
					<h3>CREATE EVENT</h3>
                                        ...
                                        <table>
                                            <tr>
                                                <th>EVENT DATE</th><td><input type="date" name="edate" required=""></td></tr>
                                            <tr><th>EVENT NAME</th><td><input type="text" name="ename" required=""></td></tr>
                                            <tr><th>DESCRIPTION</th><td><textarea cols="25" rows="10" name="desc" required=""></textarea></td></tr>
