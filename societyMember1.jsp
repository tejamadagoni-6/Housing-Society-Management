            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="Hoseowner.jsp"> House Owner</a></li>
...
<form action="societyMember1.jsp" method="post">
<table>
    <tr> <td>ENTER PASSWORD</td><td><input type="password" name="pwd" required=""></td></tr>
...
if(pwd!=null){
   String query="update member set password='"+pwd+"' where email='"+email+"'";
  ...
  int i=st.executeUpdate(query);
   if(i>0){
     %>
       ...
       %>
       <script type="text/javascript">
           window.alert("Password failed to set");
